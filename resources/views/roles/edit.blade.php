...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="role" value="{{ old('role',$role->rolename) }}" class="form-control @error('role') is-invalid @enderror"  placeholder="Masukkan Nama Role">
            <span style="color :red">@error('role'){{ $message }} @enderror</span>
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Deskripsi</label>
            <input type="text" name="description" value="{{ old('description', $role->description) }}" class="form-control @error('description') is-invalid @enderror"  placeholder="Deskripsi Role">
